...
class GuiTestLayer : public Core::Layer {
   ...
   private: 
      ...
      std::unique_ptr<Core::RenderDevice> m_renderDevice;
      Core::EntityID m_selectedID;
...
std::shared_ptr<Core::ShaderProgram> createShaderProgram(std::shared_ptr<Core::Shader> vertex, std::shared_ptr<Core::Shader> fragment);
};
